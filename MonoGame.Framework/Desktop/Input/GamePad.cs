    ...
    public static class GamePad
    {
        ...
        private static GamePadState ReadState(PlayerIndex index, GamePadDeadZone deadZone)
        {
            ...
            if (INTERNAL_isGameController[(int)index])
            {
                ...
                //TODO: Falta porner el gc_buttonState
                gc_dpad = CreateGamePadDPad(gc_buttonState);//new GamePadDPad(gc_buttonState);
            ...
            // DPad
            //TODO: poner el buttons.buttons
            GamePadDPad dpad = CreateGamePadDPad(buttonState);//new GamePadDPad(buttons.buttons);

            // Return the compiled GamePadState.
            return new GamePadState(sticks, triggers, buttons, dpad);
        }

        private static GamePadDPad CreateGamePadDPad(Buttons buttonsState)
        {
            ...
            if ((buttonsState & Buttons.DPadDown) == Buttons.DPadDown)
                Down = ButtonState.Pressed;
            if ((buttonsState & Buttons.DPadLeft) == Buttons.DPadLeft)
                Left = ButtonState.Pressed;
            if ((buttonsState & Buttons.DPadRight) == Buttons.DPadRight)
                Right = ButtonState.Pressed;
            if ((buttonsState & Buttons.DPadUp) == Buttons.DPadUp)
